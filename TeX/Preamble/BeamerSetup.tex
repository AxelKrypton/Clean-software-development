...
% Make subsections frames
\newif\ifMakeSubsectionFrame
...
\mode<presentation>
{
    ...
    \colorlet{digression}{Purple}
    \colorlet{exercise}{PS}
    \colorlet{closing}{PQ}
    \setbeamercolor{lecture section}{bg=lecture, fg=BGLIGHT}
    \setbeamercolor{digression section}{bg=digression, fg=BGLIGHT}
    ...
    \installTOCbeamertemplate{digression}
...
%   3. The vertical spacing mechanism of the TOC has been changed to use \itemsep length to space sections
