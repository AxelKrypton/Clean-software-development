...
\newcommand{\BreakFrame}[1]{\AlertFrame[Gray!75]{#1}}

% Command to vertically center emoji
\newsavebox{\emojibox}
\NewDocumentCommand{\Emoji}{O{\normalsize} O{0.15} m}{%
    \sbox{\emojibox}{#1\emoji{#3}}%
    % shift is a fraction of the strutbox height (≈ font size)
    \raisebox{-#2\ht\emojibox}{\usebox{\emojibox}}%
}
