...
emph=[2]{cout, data, sum, sum1, sum2, data, dataSet, dataSet1, dataSet2, first, last, argc, argv, minesweeper,
         number, i, c, f, b, list, gameBoard, flaggedCells, cell, realDaysPerIdealWeek, numberOfTotalRealWeeks,
         weeksPerTask, taskDaysEstimate, s, t, j, e, employee, timePattern, iterationNumber,
...
emph=[7]{age, flags, title, author, tracks, duration, cdList, grinder, status, isEmpty_},
