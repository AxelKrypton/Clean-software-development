...
$$
Allow us to construct a \textbf{jackknife estimator}
...
\begin{frame}{Resampling: Bootstrap}
We construct the \textbf{bootstrap} mean in sample $i$ by
$$
X_{B,i}\equiv\frac{1}{N}\sum_{j=1}^Nn_{ij}X_j
$$
Just like jackknife, the \textbf{bootstrap estimator} is
$$
